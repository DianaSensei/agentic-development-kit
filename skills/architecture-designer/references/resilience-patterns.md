...
Saga idempotency (each step must be safely re-runnable) and full state-persistence patterns are
covered alongside distributed transactions in `references/distributed-data-management.md`.
...
- Multiple read models beneficial (see `references/distributed-data-management.md`)
