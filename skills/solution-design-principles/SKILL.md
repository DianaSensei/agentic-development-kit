...
| Code Design Heuristics      | `references/code-design-heuristics.md` | DRY/KISS/YAGNI, coupling & cohesion, composition over inheritance, Law of Demeter, method decomposition/call depth (SLAP), re-validation vs. TOCTOU (Command-Query Separation) |
