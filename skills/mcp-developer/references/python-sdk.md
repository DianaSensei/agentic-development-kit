...
async def get_weather(location: str) -> str:
    ...
    try:
        ...
        raise McpError(ErrorData(code=INVALID_PARAMS, message=f"Unknown location: {location}"))
    except Exception as e:
        raise McpError(ErrorData(code=INTERNAL_ERROR, message=f"Weather lookup failed: {e}"))
```
