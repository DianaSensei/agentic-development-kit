...
2. Launch parallel Task subagents, each invoking the relevant skill from the Step 0 skill map
   (e.g. architecture-designer for system-impact assessment, security-audit for auth/data
...
Subagent 2 (security-audit): "What security concerns exist for file upload in this stack?"
